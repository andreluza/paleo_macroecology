...
pdf(file = here ("output", "figures", "covariate_corr.pdf"))
...
samples_paleo_cynodontia_binomial_run <- lapply (c ("Non-mammaliaform cynodonts",
                                                    ...
                                                    "Mammalia" 
                                                      ...
                                                      save(samples_paleo_cynodontia_binomial,
                                                           file = paste0 ("output/global/CMR_global_binomial_50spp_", i,".RData"))
...
# https://environmentalevidencejournal.biomedcentral.com/articles/10.1186/s13750-023-00301-6
