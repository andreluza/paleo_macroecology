...
The proportional change (PCh) (Bambach et al. 2004) depicts the difference in the number of taxa in the end relative to the beginning of a given period, as follows:
...
# Results
The analyzed dataset comprises 1139 genera observed at 17 time intervals and 1769 geological formations. Thus, if all intervals and geological formations were sampled we would have 30.073 possible observations per taxon/genus with this dataset. However, the dataset is quite sparse, with many missing observations, and had only 7.1 % (n=2.149 observations) out of the possible observations per taxon. 
