...
We found that the depression in the number of genera found in Tr-J boundary was a byproduct of high extinction rates during the Rhaetian and the intervals preceding it (Norian and Carnian), when extinction rates far surpassed the origination rates (as shown by the relative extinction rates, *RER[t]*). 

Psi.eq showed the genera undergoing high turnover rates over time. A total of 18% (n=210 out of 1139) of the studied genera showed a consistent declining trend over time, which can be as index fossils to characterizing different ecological communities and dating rocks.
